...
func (id *InvestorDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(investor.Table, sqlgraph.NewFieldSpec(investor.FieldID, field.TypeUUID))
...
func (ido *InvestorDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{investor.Label}
	default:
		return nil
	}
}
